...
public class Constants {
    ...
    public static final int MERGE_MAX_LINE_GAP = 80; //50is ok
    public static final int BOUNDING_GAP_REMOVAL = 3;//0.05 - 0.1 is ok
    ...
    public static final int REMOVE_AFTER_MERGE_THRESHOLD = 120;
